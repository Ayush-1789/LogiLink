...
# MAIN FUNCTION
# -------------------------------------------------------------------------
def main(source: str, destination: str, priority: int, goods_type: str, cargo_weight: float):
    """
    ...
    # Get user inputs
    print("Please source:",source)
    print("Please destination:",destination)
